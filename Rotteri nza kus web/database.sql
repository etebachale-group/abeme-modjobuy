-- Database schema for Rotteri nza kus web application

-- Create database
CREATE DATABASE IF NOT EXISTS rotteri_nza_kus;
USE rotteri_nza_kus;
...
INSERT INTO admins (user_id, company_name) VALUES (1, 'Rotteri Nza Kus Admin');